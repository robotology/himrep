...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md0}{}\doxysection{Description}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md0}
This module is a basic Y\+A\+RP wrapper for \href{http://caffe.berkeleyvision.org/}{\texttt{ Caffe}}, which receives as input a stream of images (of type {\ttfamily yarp\+::sig\+::\+Image}), feeds them to a Convolutional Neural Network (C\+NN) model and produces as output a corresponding stream of vectors (of type {\ttfamily yarp\+::sig\+::\+Vector}), which can be extracted from any C\+NN layer.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md1}{}\doxysection{Installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md1}
\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md2}{}\doxysubsection{Dependencies}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md2}
...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md3}{}\doxysubsection{Compilation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md4}{}\doxysection{Setup}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md4}
...
The setup procedure basically follows the \href{http://caffe.berkeleyvision.org/gathered/examples/feature_extraction.html}{\texttt{ Extracting Features}} example provided with Caffe. If you are not interested in the details, you can execute the following instructions and use one of these two models with the default module parameters. We provide a little more explanataion hereafter for those who want to try different or custom Caffe models and settings.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md5}{}\doxysubsection{Download binary Caffe models (.\+caffemodel)}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md5}
...
by downloading, in this folder, the {\ttfamily Res\+Net-\/50-\/model.\+caffemodel} file from the \href{https://onedrive.live.com/?authkey=\%21AAFW2-FVoxeVRck&id=4006CBB8476FF777\%2117887&cid=4006CBB8476FF777}{\texttt{ One\+Drive link}} specified at the webpage.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md6}{}\doxysubsection{Configure .\+prototxt and .\+ini with absolute paths}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md6}
...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md7}{}\doxysubsubsection{File .\+prototxt\+: configuration}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md7}
...
For {\ttfamily Res\+Net-\/50} we do not need to modify anything.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md8}{}\doxysubsubsection{File .\+ini\+: configuration}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md8}
...
For other parameters and input and output ports we refer to the module documentation \href{http://robotology.github.io/himrep/doxygen/doc/html/group__caffeCoder.html}{\texttt{ here}}.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md9}{}\doxysection{Detailed explanation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md9}
...
Another important parameter to be set in the {\ttfamily .ini} file is the tag/name of the output of the layer we want to read. This can be specified by setting the {\ttfamily blob\+\_\+name} parameter.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md10}{}\doxysection{Additional notes on Caffe installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md10}
For a complete and continuously updated guide to how to install Caffe in any configuration you should go to \href{http://caffe.berkeleyvision.org/installation.html}{\texttt{ Caffe -\/ Installation}}. We do not cover here exhaustively the procedure. We just report the procedure we followed at present (07/2017) to use Caffe from this module on Ubuntu 16.\+04 L\+TS.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md11}{}\doxyparagraph{C\+U\+D\+A installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md11}
Download and install C\+U\+DA drivers and toolkit by following \href{http://docs.nvidia.com/cuda/cuda-installation-guide-linux/\#axzz4BkDT7m6r}{\texttt{ C\+U\+DA Installation Guide for Linux}}.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md12}{}\doxyparagraph{cu\+D\+N\+N installation (optional but recommended)}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md12}
Download the {\bfseries{cu\+D\+NN}} version you need (depending on the toolkit version) from \href{https://developer.nvidia.com/cuDNN}{\texttt{ N\+V\+I\+D\+IA cu\+D\+NN library}} (you have to sign up as C\+U\+DA Registered Developer, it\textquotesingle{}s for free), and install it by following the instructions.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md13}{}\doxyparagraph{B\+L\+A\+S installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md13}
...
and setting the {\ttfamily Open\+B\+L\+A\+S\+\_\+\+H\+O\+ME} environment variable to the installation path to allow Caffe finding it.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md14}{}\doxyparagraph{B\+O\+O\+S\+T installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md15}{}\doxyparagraph{Open\+C\+V installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md15}
...
Where in the C\+Make configuration you should have set the installation path ({\ttfamily C\+M\+A\+KE\textbackslash{}\+\_\+\+I\+N\+S\+T\+A\+LL\textbackslash{}\+\_\+\+P\+R\+E\+F\+IX}) to one of your choice. In this case, set the {\ttfamily Open\+C\+V\+\_\+\+D\+IR} environment variable to the installation path to allow Caffe finding it.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md16}{}\doxyparagraph{Other packages}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md16}
...
snappy\+:~\newline
 {\ttfamily sudo apt-\/get install libsnappy-\/dev}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md17}{}\doxyparagraph{Caffe compilation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md17}
...
Finally, set the {\ttfamily Caffe\+\_\+\+D\+IR} environment variable to the installation path to allow finding Caffe via {\ttfamily find\+\_\+package}.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md18}{}\doxysection{Citation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md18}
...
\end{DoxyVerb}
\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md19}{}\doxysection{License}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_caffeCoder_README_autotoc_md19}
