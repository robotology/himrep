...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md20}{}\doxysection{Description}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md20}
This module is a basic Y\+A\+RP wrapper for \href{https://developer.nvidia.com/tensorrt}{\texttt{ Tensor\+RT}}, which receives as input a stream of images (of type {\ttfamily yarp\+::sig\+::\+Image}), feeds them to a Convolutional Neural Network (C\+NN) model and produces as output a corresponding stream of vectors (of type {\ttfamily yarp\+::sig\+::\+Vector}), which can be extracted from any C\+NN layer.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md21}{}\doxysection{Installation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md21}
\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md22}{}\doxysubsection{Dependencies}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md22}
...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md23}{}\doxysubsection{Compilation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md23}
...
\end{DoxyItemize}\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md24}{}\doxysection{Setup}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md24}
...
If you are not interested in the details, you can execute the following instructions and use one of these two models with the default module parameters. We provide a little more explanataion hereafter for those who want to try different or custom Caffe models and settings.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md25}{}\doxysubsection{Download binary Caffe models (.\+caffemodel)}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md25}
...
by downloading, in this folder, the {\ttfamily Res\+Net-\/50-\/model.\+caffemodel} and the {\ttfamily Res\+Net-\/50-\/deploy.\+prototxt} files from the \href{https://onedrive.live.com/?authkey=\%21AAFW2-FVoxeVRck&id=4006CBB8476FF777\%2117887&cid=4006CBB8476FF777}{\texttt{ One\+Drive link}} specified at the webpage.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md26}{}\doxysubsection{Configure .\+ini}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md26}
...
For other parameters and input and output ports we refer to the module documentation \href{http://robotology.github.io/himrep/doxygen/doc/html/group__GIECoder.html}{\texttt{ here}}.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md27}{}\doxysection{Detailed explanation}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md27}
...
Another important parameter to be set in the {\ttfamily .ini} file is the tag/name of the output of the layer we want to read. This can be specified by setting the {\ttfamily blob\+\_\+name} parameter.\hypertarget{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md28}{}\doxysection{License}\label{md__home_runner_work_himrep_himrep_gh-pages_modules_GIECoder_README_autotoc_md28}
