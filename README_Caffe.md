...
tar -xzvf cudnn-6.5-linux-R1.tgz <br />
cd cudnn-6.5-linux-R1 <br />
sudo cp lib* /usr/local/cuda/lib64/ <br /> 
...
tar --bzip2 -xf /path/to/boost_1_55_0.tar.bz2 <br />
./bootstrap.sh --prefix=path/to/install/dir <br />
./b2 install
